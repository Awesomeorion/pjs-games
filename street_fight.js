function program() {
      ...
      player1.prototype.draw = function() {
          ...
          switch(this.pos) {
              case "idle":
                  if(this.facing !== 1) {
                      image(images.chun_li.idlel,-17,0);
                  }else{
                      image(images.chun_li.idler,0,0);
                  }
              break;
              case "punch":
                  if(this.facing !== 1) {
                      image(images.chun_li.punchl,0,0);
                  }else{
                      image(images.chun_li.punchr,-15,0);
                  }
              break;
              case "kick":
                  if(this.facing !== 1) {
                      image(images.chun_li.kickl,-13,0);
                  }else{
                      image(images.chun_li.kickr,-7,0);
                  }
              break;
              case "ded":
                  pushMatrix();
      ...
      player1.prototype.hit = function() {
          if(p2.health>0) {
              if(keys[81] && rectcollide(this, p2)){
                  p2.health -= this.strength+1;
              }
              if(keys[69] && rectcollide(this, p2)){
                  p2.health -= this.strength;
              }
          }
      };
      ...
      player2.prototype.hit = function() {
          if(p1.health>0) {
              if(keys[191] && rectcollide(this, p1)){
                  p1.health -= this.strength+1;
              }
              if(keys[190] && rectcollide(this, p1)){
      ...
      var p1 = new player1(50,245);
      var p2 = new player2(450,245);
      ...
      draw = function() {
          ...
          rect(325,30,200,15);
          fill(255, 247, 0);
          rect(75,30,p1.health*2,15);
          rect(325,30,p2.health*2,15);
          pushStyle();
          rectMode(CENTER);
          fill(59, 115, 255);
          rect(300,37,50,32);
          fill(255, 255, 255);
          pixelText("K",282,25,4);
          pixelText("O",302,25,4);
          popStyle();
          
          fill(255, 255, 255);
          pixelText("CHUN LI",401,56,3);
          pixelText("CHUN LI",75,55,3);
          pixelText("1P",26,27,3);
          pixelText("2P",546,27,3);
          fill(245, 112, 10);
          pixelText("CHUN LI",400,55,3);
          pixelText("CHUN LI",74,54,3);
          pixelText("1P",25,26,3);
          pixelText("2P",545,26,3);
          
          if(time === "infinite") {
              image(images.infinity,279,60);
          }else{  
              fill(255, 0, 0);
              textFont(createFont("courier"),30);
              textAlign(CENTER);
              text(floor(time),300,80);
              time -= 0.017;
          }
          ...
          if (time <= 0) {
              ...
              if(p1.health>p2.health) {
                  pixelText("PLAYER 1 WINS",150,106,4);
              }else if(p2.health>p1.health) {
                  pixelText("PLAYER 2 WINS",150,106,4);
              }else{
                  pixelText("TIE GAME",210,106,4);
              }
              time += 0.015;
          }
      };
